...
public class MapInstance : EInteractable
{
    public GameObject mapImageInstance; // Instance for the map image (Canvas)
    ...
    private void Start()
    {
        ...
        if (mapImageInstance != null)
        {
            currentMapImage = mapImageInstance;
